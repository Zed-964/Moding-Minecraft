...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties FLUOR_PROPERTIES = new ForgeFlowingFluid.Properties(() -> FLUOR_FLUID.get(), () -> FLUOR_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL, WATER_FLOWING_RL).density(1510).temperature(85).viscosity(6).overlay(WATER_OVERLAY_RL).color(0xffd4af00)).slopeFindDistance(3).levelDecreasePerBlock(2).block(() -> ModFluids.FLUOR_BLOCK.get()).bucket(() -> ModItems.FLUOR_BUCKET.get());
    ...
    public static final ForgeFlowingFluid.Properties HYDRAZINE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> HYDRAZINE_FLUID.get(), () -> HYDRAZINE_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL, WATER_FLOWING_RL).density(1000).temperature(275).viscosity(6).overlay(WATER_OVERLAY_RL).color(0xffcfd8dc)).slopeFindDistance(3).levelDecreasePerBlock(2).block(() -> ModFluids.HYDRAZINE_BLOCK.get()).bucket(() -> ModItems.HYDRAZINE_BUCKET.get());
    ...
    public static final ForgeFlowingFluid.Properties OXYGEN_PROPERTIES = new ForgeFlowingFluid.Properties(() -> OXYGEN_FLUID.get(), () -> OXYGEN_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL, WATER_FLOWING_RL).density(1141).temperature(90).viscosity(6).overlay(WATER_OVERLAY_RL).color(0xff89cff0)).slopeFindDistance(3).levelDecreasePerBlock(2).block(() -> ModFluids.OXYGEN_BLOCK.get()).bucket(() -> ModItems.OXYGEN_BUCKET.get());
    ...
    public static final ForgeFlowingFluid.Properties KEROSENE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> KEROSENE_FLUID.get(), () -> KEROSENE_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL, WATER_FLOWING_RL).density(800).temperature(423).viscosity(6).overlay(WATER_OVERLAY_RL).color(0xfff5f5dc)).slopeFindDistance(3).levelDecreasePerBlock(2).block(() -> ModFluids.KEROSENE_BLOCK.get()).bucket(() -> ModItems.KEROSENE_BUCKET.get());
    ...
    public static final ForgeFlowingFluid.Properties NITRIC_ACID_PROPERTIES = new ForgeFlowingFluid.Properties(() -> NITRIC_ACID_FLUID.get(), () -> NITRIC_ACID_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL, WATER_FLOWING_RL).density(1510).temperature(233).viscosity(6).overlay(WATER_OVERLAY_RL).color(0xffffaf00)).slopeFindDistance(3).levelDecreasePerBlock(2).block(() -> ModFluids.NITRIC_ACID_BLOCK.get()).bucket(() -> ModItems.NITRIC_ACID_BUCKET.get());
